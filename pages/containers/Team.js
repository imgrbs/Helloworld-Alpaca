          ...
          <div className="container">
            <div className="row">
              <div className="col-md-3">
                ...
                พบกับผู้สรรสร้างหน้าตาของเว็บให้ออกมาใช้งานได้จริง โดยพี่ๆ จะมี Workshop เทรนน้องๆ 
                แม้น้องจะไม่มีพื้นฐาน พี่ๆก็จะเป็นคนสอนน้อง ให้เป็นผู้สร้างหน้าเว็บ ดั่งพ่อมดเสกเวทมนต์ 
                ...
                ที่เป็นที่ต้องการของตลาดและสามารถใช้ทำงานได้จริง หรือแม้กระทั้งการจัดหน้าเว็บยังไงให้สวยงาม
                 และ น่าสนใจ มาเจอกันได้ที่ #HelloFrontEnd 🙂
              ...
              <div className="col-md-3">
                ...
                ถ้าน้องๆ เข้ามาใน #HelloDesign น้องๆ จะได้พบกับเนื้อหาที่พี่ๆ เตรียมไว้มากมาย 
                ไม่ว่าจะเป็น การดราฟ การลงสี แสง และเงา ออกแบบคาแรคเตอร์ รวมถึง UX/UI ซึ่งเป็นทักษะที่น่าจับตามองในยุคนี้!!
              ...
              <div className="col-md-3">
                ...
                <Modal pic={'al8.png'} title={'Hello-Game'} desc={`หากน้องๆเป็นหนึ่งในผู้ที่ชื่นชอบเกม มาร่วมเป็นส่วนหนึ่งกับ #HelloGame แล้วน้องจะได้พับกบ เอ้ย พบกับ
              ...
              <div className="col-md-3">
                ...
                #HelloInfra จะพาน้อง ๆ ไปตะลุยลง ดัน Linux Command, yum, npm, และ nginx ! 
                เพื่อให้น้อง ๆ ใช้งานเป็น และใช้กับงานจริงได้ หากคำที่พิมมาเมื่อกี้ไม่เคยเห็นไม่เคยได้ยิน 
                ไม่ต้องกลัวว่าจะทำไม่ได้ พี่ ๆ จะพาน้อง ๆ ไล่ตั้งแต่บอสตัวเล็ก ไปจนตัวใหญ่ไม่ต้องกลัว HP หมดกันเลย ~
